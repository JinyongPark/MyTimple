...
<div class="body">
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="/bbs/BbsWriterOk.vs" method="POST" accept-charset="utf-8">
		<div id="input-subject-select" style="margin-top: 15px;">
			종 류 : 
			<select id="genreSel" name="genreSel" style="width: 730px; margin-bottom: 10px; float: right;margin-top:-10px;">
				<c:if test="${memSeq == '0'}">
		...
		<div id="input-subject-box" style="margin-top: 50px;">
			제 목 : <input type="text" id="subject" name="subject" style="width: 730px; margin-bottom: 30px; float: right; margin-top:-10px;" placeholder=" 제목을 입력하세요."/>
		</div>
		<!-- 에디터 컨테이너 시작 -->

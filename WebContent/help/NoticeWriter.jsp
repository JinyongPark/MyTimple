...
<script src="help/js/vendor/modernizr.js"></script>
<script src="/js/header.js"></script>
<link rel="stylesheet" href="/help/css/editor.css" type="text/css"/>
<script src="/help/js/editor_loader.js?environment=development" type="text/javascript" charset="utf-8"></script>
<style type="text/css">
...
<div class="body">
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="/help/NoticeWriterOk.vs" method="POST" accept-charset="utf-8">
		<div id="input-subject-select" style="margin-top: 15px;">

		</div>
		<div id="input-subject-box" style="margin-top: 15px;">
			제 목 : <input type="text" id="subject" name="subject" style="width: 730px; margin-bottom: 10px; float: right;" placeholder=" 제목을 입력하세요."/>
		</div>
		<!-- 에디터 컨테이너 시작 -->
	...
	<!-- 버튼 리스트 -->
	<div id="btnList">
		<input type="text" id="saveBtn" placeholder="저장하기" readonly="readonly" onclick='saveContent()'/>
	</div>
	<!-- 버튼 리스트 끝 -->
